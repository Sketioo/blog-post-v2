    ...
    <div class="container py-md-5">
        <div class="row align-items-center">
            ...
            <div class="col-lg-5 pl-lg-5 pb-3 py-lg-5">
                <form action="{{ route('users.register') }}" method="POST" id="registration-form">
                    @csrf
                    <div class="form-group">
                        <label for="username-register" class="text-muted mb-1"><small>Username</small></label>
                        <input value="{{ old('username') }}" name="username" id="username-register" class="form-control" type="text"
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{ old('password') }}" name="password" id="password-register" class="form-control" type="password"
